...
public class ResumenGeneralFragment extends Fragment {
    ...
    private void llenarDatos(View v) {
        ...
        setText(v, R.id.tvMAV,           "%.4f V",    analisis.mav);
        setText(v, R.id.tvWL,            "%.4f V",    analisis.wl);
        ...
        // Dinamómetro
        setText(v, R.id.tvFuerzaMax,  "%.2f N",   analisis.fuerzaMaxima);
        setText(v, R.id.tvRFD,        "%.2f N/s", analisis.rfd);
        setText(v, R.id.tvTiempoPico, "%.0f ms",  analisis.tiempoHastaPico);
        setText(v, R.id.tvImpulso,    "%.3f N·s", analisis.impulso);
        ...
        // Fusión
        setText(v, R.id.tvEficMuscular,  "%.4f N/V",    analisis.eficienciaMuscular);
